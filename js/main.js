...
var listAudio = [
...

  {
    ...
    file: "audio/Виталий Ефремочкин - Воплощение добра.mp3",
    duration: "07:46"
  },

  {
    name: "Виталии Ефремочкин - Выше солнца выше неба",
    file: "audio/Виталий Ефремочкин - Выше солнца выше неба.mp3",
    duration: "06:29"
  },

  {
    name: "Виталии Ефремочкин - Не умру я но буду",
    file: "audio/Виталий Ефремочкин - Не умру я но буду.mp3",
    duration: "06:21"
  },

  {
    name: "Виталии Ефремочкин - Святои",
    file: "audio/Виталий Ефремочкин - Святои.mp3",
    duration: "10:04"
  },

  {
    name: "Виталии Ефремочкин - Танцуи",
    file: "audio/Виталий Ефремочкин - Танцуи.mp3",
    duration: "10:05"
  },

  {
    name: "Виталии Ефремочкин - Царь цареи",
    file: "audio/Виталий Ефремочкин - Царь цареи.mp3",
    duration: "04:23"
  },
...
for (var i = 0; i < listAudio.length; i++) {
  ...
  console.log(i, listAudio[i].name, listAudio[i].duration)
}
var indexAudio = 0;
